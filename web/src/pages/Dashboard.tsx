        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              {/* GitHub Status */}
              <Card className={`border-2 transition-all hover:shadow-md ${
                systemStatus.github.status === 'healthy' ? 'border-green-500' :
                systemStatus.github.status === 'degraded' ? 'border-yellow-500' : 'border-red-500'
              }`}>
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center">
              ...
              {/* Cache Status */}
              <Card className={`border-2 transition-all hover:shadow-md ${
                systemStatus.cache.status === 'healthy' ? 'border-green-500' :
                systemStatus.cache.status === 'degraded' ? 'border-yellow-500' : 'border-red-500'
              }`}>
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center">
